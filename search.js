...
/**
 * The search function accepts a query. The query is then converted to a embedding
 * and then compared to the embeddings of the movies. The embeddings are placed within a vector store.
 * The vector store is a data structure used to store and compare embeddings.
 * The closer the embeddings are to each other, the more similar they are.
 * @param {*} query
 * @param {*} count
 * @returns
 */
